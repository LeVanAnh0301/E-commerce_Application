...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        if is_exists_cart_item: 
            ...
            existing_variation_list = [list(item.variations.all()) for item in cart_items] # list các thành phần trong cart_iitem 
            id = [item.id for item in cart_items] # list các id của từng items trong list cart_items
